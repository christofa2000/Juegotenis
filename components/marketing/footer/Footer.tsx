          ...
          <div>
            ...
            <div className="space-y-3 text-text-100 text-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p>Núñez: Santiago Calzadilla 1350, C1429AAH Cdad. Autónoma de Buenos Aires, Argentina</p>
                  <p>Caballito: Doblas 1043, C1424 Cdad. Autónoma de Buenos Aires, Argentina</p>
                </div>
              </div>
